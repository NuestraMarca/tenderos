	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title"><strong id="modal-producer-name">Mr. Brennon Stamm MD</strong>
					@if(Auth::user()->isAdmin()) 
                        <a id="modal-producer-id" href="" title="Editar" class="btn btn-primary">
                        	<i class="fa fa-pencil"></i>
                        </a> 
                        <a id="modal-producer-shopping" href="" title="Editar" class="btn btn-info">
